-- ============================================
-- Invoice Manager - Complete Schema
...
CREATE TABLE organizations (
  ...
  phone TEXT,
  email TEXT,
  pib TEXT,  -- Poreski identifikacioni broj
  pdv_number TEXT,  -- PDV registracioni broj
...
CREATE TABLE invoices (
  ...
  -- Invoice type (incoming = from supplier, outgoing = to customer)
...
CREATE POLICY "Owners can update their organizations"
  ON organizations FOR UPDATE USING (is_org_owner(id));

CREATE POLICY "Owners can delete their organizations"
  ON organizations FOR DELETE USING (is_org_owner(id));
...
CREATE POLICY "Owners can manage members"
  ON organization_members FOR UPDATE USING (is_org_owner(organization_id));

CREATE POLICY "Owners can remove members"
  ON organization_members FOR DELETE USING (is_org_owner(organization_id) OR user_id = auth.uid());
...
CREATE POLICY "Owners can delete projects"
  ON projects FOR DELETE USING (is_org_owner(organization_id));

-- Invoices Policies
CREATE POLICY "Members can view org invoices"
  ON invoices FOR SELECT USING (is_org_member(organization_id));

CREATE POLICY "Members can create invoices"
  ON invoices FOR INSERT WITH CHECK (is_org_member(organization_id));

CREATE POLICY "Members can update invoices"
  ON invoices FOR UPDATE USING (is_org_member(organization_id));

CREATE POLICY "Owners can delete invoices"
  ON invoices FOR DELETE USING (is_org_owner(organization_id));

-- Reports Policies
CREATE POLICY "Members can view reports"
  ON reports FOR SELECT USING (is_org_member(organization_id));

CREATE POLICY "Members can create reports"
  ON reports FOR INSERT WITH CHECK (is_org_member(organization_id));

CREATE POLICY "Members can update reports"
  ON reports FOR UPDATE USING (is_org_member(organization_id));
...
CREATE POLICY "Members can view org invitations"
  ON organization_invitations FOR SELECT USING (is_org_member(organization_id));

CREATE POLICY "Owners can create invitations"
  ON organization_invitations FOR INSERT WITH CHECK (is_org_owner(organization_id));

CREATE POLICY "Anyone can view invitation by token"
  ON organization_invitations FOR SELECT USING (true);
